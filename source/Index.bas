...
Sub GenerateIndex As String
	...
	Dim body1 As MiniHtml = Create("body").up(html1)
...
Sub GenerateModal As String
	...
	Dim h5 As MiniHtml = Create("h5").up(div3)
	h5.cls("modal-title")
	...
	Dim p1 As MiniHtml = Create("p").up(div4)
...
Sub Button As MiniHtml
	Return Create("button", True)
End Sub

Sub Div As MiniHtml
	Return Create("div", True)
End Sub
